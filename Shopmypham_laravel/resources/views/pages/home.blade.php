							...
							<ul>
								...
								<li data-index="rs-10"
									...
									<img src="{{('public/frontend/images/dummy.png')}}" alt=""
										data-lazyload="{{('public/Upload/Slide/Slide-4.jpg')}}"
								...
								<li data-index="rs-11"
									...
									<!-- MAIN IMAGE -->
									<img src="{{('public/frontend/images/dummy.png')}}" alt=""
										data-lazyload="{{('public/Upload/Slide/Slide-1.jpg')}}"
										data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone"
										data-scalestart="100" data-scaleend="110" data-rotatestart="0" data-rotateend="0" data-blurstart="0"
										data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
									<!-- LAYERS -->
								...
								<li data-index="rs-12"
									...
									data-param8="" data-param9="" data-param10="" data-description="">
									<!-- MAIN IMAGE -->
									<img src="{{('public/frontend/images/slide-4')}}" alt=""
										data-lazyload="{{('public/Upload/Slide/Slide-3.jpg')}}"
										data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone"
										data-scalestart="100" data-scaleend="110" data-rotatestart="0" data-rotateend="0" data-blurstart="0"
										data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
									<!-- LAYERS -->
			...
			<div class="row">
				<div class="col-md-4 mb-30">
					...
					<div class="single-category single-category--three">
						...
						<div
							...
							<img src="{{('public/frontend/images/banners/nuoc_hoa.jpg')}}" class="img-fluid" alt="">
						</div>
						...
						<div
							...
							<div class="title">
								<p><a href="{{URL::to('/product-of-category_12')}}">Nước Hoa<span>Thơm Mát</span></a></p>
				...
				<div class="col-md-4 mb-30">
					...
					<div class="single-category single-category--three">
						...
						<div
							class="single-category__image single-category__image--three single-category__image--three--creativehome single-category__image--three--banner">
							<img src="{{('public/frontend/images/banners/son.jpg')}}" class="img-fluid" alt="">
						</div>
						...
						<div
							class="single-category__content single-category__content--three single-category__content--three--creativehome  single-category__content--three--banner mt-25 mb-25">
							<div class="title">
								<p><a href="{{URL::to('/product-of-category_17')}}">Son <span>Chất lượng</span></a></p>
				...
				<div class="col-md-4 mb-30">
					...
					<div class="single-category single-category--three">
						...
						<div
							class="single-category__image single-category__image--three single-category__image--three--creativehome single-category__image--three--banner">
							<img src="{{('public/frontend/images/banners/kem.jpg')}}" class="img-fluid" alt="">
						</div>
						...
						<div
							class="single-category__content single-category__content--three single-category__content--three--creativehome  single-category__content--three--banner mt-25 mb-25">
							<div class="title">
								<p><a href="{{URL::to('/product-of-category_18')}}">Kem trị mụn<span>Nội địa</span></a></p>
			...
			<div class="row mb-75">
				<div class="col-6">
					<div
						...
						<p>2021 <span class="line">NEW</span></p>
					</div>
				</div>
